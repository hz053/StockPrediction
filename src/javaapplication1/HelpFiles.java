 ...
 * @author rasikh
 */
public class HelpFiles extends javax.swing.JFrame {

    /**
     * Creates new form HelpFiles
     */
    public HelpFiles() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelpFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
